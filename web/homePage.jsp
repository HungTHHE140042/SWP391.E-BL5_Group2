                        ...
                        <div class="row align-items-center">
                            <div class="col-12">
                                <div class="hero_content">
                                    ...
                                    <a class="btn btn-link wow fadeInUp" data-wow-delay="0.3s" data-wow-duration="1.3s" href="productDetails?productID=${lastProduct.productID}">Buy now <img width="20" height="20" src="assets/img/icon/arrrow-icon.webp" alt=""> </a>
                                </div>
                            </div>
                        </div>
                    </div>    
