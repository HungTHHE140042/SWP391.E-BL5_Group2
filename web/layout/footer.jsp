<%-- 
    Document   : footer
    Created on : Apr 12, 2022, 8:32:12 PM
    Author     : trinh
--%>
                                ...
                                <div class="footer_winners_gallery">
                                    <div class="footer_winners_list d-flex">
                                        <div class="footer_winners_thumb">
                                            <a href="#"><img aria-label="game-team" width="75" height="75" src="https://i.ibb.co/sPYKw8q/Dinh-Dep-Trai.jpg" alt=""></a>
                                        </div>
                                        <div class="footer_winners_thumb">
                                            <a href="#"><img aria-label="game-team" width="75" height="75" src="https://i.ibb.co/2yxkzK0/sang.jpg" alt=""></a>
                                        </div>
                                        <div class="footer_winners_thumb">
                                            <a href="#"><img aria-label="game-team" width="75" height="75" src="https://i.ibb.co/Wgbw1rY/son.jpg" alt=""></a>
                                        </div>
                                    </div>
                                    <div class="footer_winners_list d-flex">
                                        <div class="footer_winners_thumb">
                                            <a href="#"><img aria-label="game-team" width="75" height="75" src="https://i.ibb.co/rw4yXC8/long.jpg" alt=""></a>
                                        </div>
                                        <div class="footer_winners_thumb">
                                            <a href="#"><img aria-label="game-team" width="75" height="75" src="https://i.ibb.co/0nmsjY3/quanghung.png" alt=""></a>
                                        </div>
                                        <div class="footer_winners_thumb">
                                            <a href="#"><img aria-label="game-team" width="75" height="75" src="https://i.ibb.co/84GCBfk/hung.jpg" alt=""></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
