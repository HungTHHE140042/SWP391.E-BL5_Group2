<%-- 
    Document   : dashboardNotificationDetail
    Created on : Apr 17, 2022, 5:23:30 PM
    Author     : trinh
--%>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <div class="div mb-4">
                            <h4><a href="dashboard-notification">Notifications</a> > Detail</h4>
                        </div>
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="div mb-4 mr-4">
                                <a href="dashboard-notification" class="btn btn-danger float-right">
